...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default="NeedleGrasp-v0")          # OpenAI gym environment name
    ...
    parser.add_argument("--buffer_size", default=1e6, type=int)     # Maximum number of transitions stored in the buffer
    parser.add_argument("--num_goals", default=1, type=int)         # Number of goals per task
    ...
    replay_buffer = ReplayBuffer(args.num_goals,env,args.buffer_size)
    ...
    for t in range(int(args.max_timesteps)):
        ...
        replay_buffer.store_transition(state,info, action, next_state, reward, done,next_info)
